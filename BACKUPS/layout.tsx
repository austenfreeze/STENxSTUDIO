...
export default async function RootLayout({
  ...
  return (
    <html lang="en" className={`${inter.variable} bg-zinc-50 text-zinc-800`}>
      {/* IMPORTANT: Ensure NO whitespace (spaces, tabs, newlines) between <html> and <body> tags below. */}
      <body>
        ...
        <AppProviders>
          ...
          <header className="border-b border-zinc-200 p-4 bg-white shadow-sm">
            <div className="container mx-auto">
              <h1 className="text-xl font-bold text-zinc-900">My Sanity Project</h1>
            </div>
          </header>

          <main className="min-h-screen container mx-auto p-4">{children}</main>

          <footer className="border-t border-zinc-200 p-4 mt-12 bg-white shadow-sm">
